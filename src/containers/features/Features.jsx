...
const Features = () => (
  <div className="xstem3__features section__padding" id="features">
    <div className="xstem3__features-heading">
      <h1 className="gradient__text">
        The precious secrets of starup success taught for free.
      </h1>
      <p>Join to learn more.</p>
    </div>
    <div className="xstem3__features-container">
